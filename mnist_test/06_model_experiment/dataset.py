...
class MorphMNIST12(Dataset):
    ...
    def __init__(self, train=True, limit_count=None): 
        ...
        print(f"\nFeature extraction complete. Saving to {cache_path}...")
        torch.save(self.cached_data, cache_path)
